...
function TargetStatGlyph({ type }: { type: 'income' | 'expense' | 'remaining' }) {
  if (type === 'income') {
    return (
      <View style={styles.targetIncomeGlyph}>
        <View style={[styles.targetIncomeBar, styles.targetIncomeBarShort]} />
        <View style={[styles.targetIncomeBar, styles.targetIncomeBarMid]} />
        <View style={[styles.targetIncomeBar, styles.targetIncomeBarTall]} />
        <View style={styles.targetIncomeCoin}>
          <Text style={styles.targetIncomeCoinText}>₺</Text>
        </View>
      </View>
    );
  }
  ...
  if (type === 'expense') {
    return (
      <View style={styles.targetExpenseGlyph}>
        <View style={styles.targetExpenseReceipt}>
          <View style={styles.targetExpenseLineLong} />
          <View style={styles.targetExpenseLineShort} />
          <View style={styles.targetExpenseDotRow}>
            <View style={styles.targetExpenseDot} />
            <View style={styles.targetExpenseDot} />
          </View>
        </View>
      </View>
  ...
  return (
    <View style={styles.targetRemainingGlyph}>
      <View style={styles.targetRemainingDiamond} />
      <View style={styles.targetRemainingSpark} />
      <View style={styles.targetRemainingBase} />
    </View>
  );
}

function CategoryGlyph({ category }: { category: EntryCategory }) {
  if (category === 'food') {
    return (
      <View style={styles.foodGlyph}>
        <View style={styles.foodPlate} />
        <View style={styles.foodForkStem} />
        <View style={styles.foodForkTop} />
        <View style={styles.foodKnife} />
      </View>
    );
  }
  ...
  if (category === 'transport') {
    return (
      <View style={styles.transportGlyph}>
        ...
        <View style={styles.transportWindow} />
        <View style={styles.transportWheelLeft} />
        <View style={styles.transportWheelRight} />
      </View>
    );
  }
  ...
  if (category === 'education') {
    return (
      <View style={styles.educationGlyph}>
        <View style={styles.educationCapTop} />
        <View style={styles.educationCapBase} />
        <View style={styles.educationCapTassel} />
      </View>
    );
  }
  ...
  if (category === 'bill') {
    return (
      <View style={styles.billGlyph}>
        <View style={styles.billPaper} />
        <View style={styles.billLineLong} />
        <View style={styles.billLineShort} />
      </View>
    );
  }
  ...
  if (category === 'shopping') {
    return (
      <View style={styles.shoppingGlyph}>
  ...
  if (category === 'salary' || category === 'freelance' || category === 'bonus') {
    return <TargetStatGlyph type="income" />;
  }

  return <TargetStatGlyph type="remaining" />;
}

function FixedMoneyGlyph() {
  return (
    <View style={styles.fixedMoneyGlyph}>
      <View style={styles.fixedMoneyCard} />
      <View style={styles.fixedMoneyCoin}>
        <Text style={styles.fixedMoneyCoinText}>₺</Text>
      </View>
    </View>
  );
}

function LimitGlyph({ period }: { period: 'monthly' | 'weekly' | 'daily' }) {
  return (
    <View style={styles.limitGlyph}>
      <View style={styles.limitCalendar}>
        <View style={styles.limitCalendarTop} />
        <View style={styles.limitCalendarLine} />
        {period !== 'monthly' ? <View style={styles.limitCalendarDot} /> : null}
      </View>
      <View
        style={[
          styles.limitBadge,
          period === 'weekly' && styles.limitBadgeWeekly,
          period === 'daily' && styles.limitBadgeDaily,
        ]}
      />
    </View>
  );
...
function TipGlyph() {
  return (
    <View style={styles.tipGlyph}>
      ...
      <View style={styles.tipBase} />
      <View style={styles.tipSpark} />
    </View>
  );
}
...
function ActionGlyph({ type }: { type: 'expense' | 'extra' }) {
  if (type === 'expense') {
    return (
      <View style={styles.actionExpenseGlyph}>
        <View style={styles.actionExpenseDot} />
        <View style={styles.actionExpenseLine} />
        <View style={styles.actionExpenseBase} />
      </View>
    );
  }

  return (
    <View style={styles.actionExtraGlyph}>
      <View style={styles.actionExtraVertical} />
      <View style={styles.actionExtraHorizontal} />
      <View style={styles.actionExtraCoin}>
        <Text style={styles.actionExtraCoinText}>₺</Text>
      </View>
    </View>
  );
}
  ...
  return (
    ...
    >
      <View style={styles.incomeRow}>
        <View style={styles.incomeRowAccent} />
            ...
            <View style={styles.targetStatRow}>
              <View style={styles.targetStatLead}>
                <View style={[styles.targetStatIconCircle, styles.targetStatRemainingCircle]}>
                  <TargetStatGlyph type="remaining" />
                </View>
        ...
        <Screen>
          ...
          <View style={styles.confirmCard}>
            ...
            <View style={styles.confirmIcon}>
              <CategoryGlyph category={pendingVoice.category} />
            </View>
      ...
      <Screen>
        ...
        <View style={styles.dashboardListCard}>
          <ScrollView
            nestedScrollEnabled
            showsVerticalScrollIndicator={false}
            style={styles.dashboardListScroll}
...
const styles = StyleSheet.create({
  ...
  targetIncomeBar: {
    ...
    width: 3,
    borderRadius: 2,
    backgroundColor: '#82A052',
  },
  targetIncomeBarShort: {
    left: 3,
    height: 8,
  },
  targetIncomeBarMid: {
  ...
  targetExpenseLineLong: {
    height: 2,
    borderRadius: 1,
    backgroundColor: '#F08A63',
    marginBottom: 3,
  },
  targetExpenseLineShort: {
    width: 6,
    height: 2,
    borderRadius: 1,
    backgroundColor: '#F08A63',
  ...
  targetRemainingGlyph: {
    width: 22,
    height: 22,
    alignItems: 'center',
    justifyContent: 'center',
  },
  targetRemainingDiamond: {
    width: 13,
    height: 13,
    borderRadius: 3,
    borderWidth: 2,
